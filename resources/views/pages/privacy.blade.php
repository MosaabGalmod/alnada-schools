@extends('layouts.app')
@section('title', 'سياسة الخصوصية – مدارس الندى النموذجية')
@section('meta_description', 'سياسة الخصوصية لمدارس الندى النموذجية الأهلية')
...
<main class="min-h-screen bg-white dark:bg-gray-950 py-20 px-4" dir="rtl" lang="ar">
    <div class="mx-auto max-w-3xl">
        <header class="mb-10 text-center">
            ...
            <h1 class="font-heading text-3xl font-extrabold text-gray-900 dark:text-white">سياسة الخصوصية</h1>

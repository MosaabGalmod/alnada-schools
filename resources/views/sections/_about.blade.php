	...
	<div class="mx-auto max-w-7xl">
		<div class="grid items-center gap-16 lg:grid-cols-2">
			...
			<div class="relative transition-all duration-700" x-data="reveal"
				...
				{{-- Floating badges --}}
				<div class="absolute -left-4 -top-4 flex items-center gap-2 rounded-2xl bg-white px-4 py-3 shadow-card">
				...
				<div class="absolute -bottom-4 -right-4 flex items-center gap-2 rounded-2xl bg-white px-4 py-3 shadow-card">

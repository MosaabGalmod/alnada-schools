...
test.describe('Stats Section', () => {
  ...
  test('heading is visible and non-empty', async ({ page }) => {
  ...
  test('renders correct number of stat cards', async ({ page }) => {
  ...
  test('icon containers are square (not stretched bars)', async ({ page }) => {
  ...
  test('each icon container contains an SVG', async ({ page }) => {
  ...
  test('counters animate to non-zero values after scroll', async ({ page }) => {
  ...
  test('counter has data-target attribute set', async ({ page }) => {
  ...
  test('each card has a visible label', async ({ page }) => {
  ...
  test('list has correct aria role', async ({ page }) => {
    await expect(page.locator('#stats [role="list"]')).toBeVisible();
  });

  test('section is labeled via aria-labelledby', async ({ page }) => {
  ...
  test('single column layout on mobile (375px)', async ({ page }) => {
  ...
  test('multi-column grid on desktop (1440px)', async ({ page }) => {
  ...
  test('dark mode: cards are visible and not white', async ({ browser }) => {
